...
<table width="867" border="0" cellpadding="0" cellspacing="0" bgcolor="#E2E2E2">
  ...
  <tr>
    ...
    <td colspan="3" valign="top" bgcolor="#FFFFFF">            <h2 class="Estilo6">VIDEOS RECIENTES                 </h2>
  <td colspan="3" valign="top" bgcolor="#FFFFFF"><span class="Estilo7">_  </span>  </tr>
  <tr>
    <td height="94"></td>
  <td colspan="10" rowspan="3" valign="top" bgcolor="#FFFFFF">                                                                                                    <span class="Estilo7">_  </span>
  </tr>
  
  
  <tr>
    <td height="90"></td>
    <td colspan="3" valign="top" bgcolor="#0000FF" bordercolor="#FF0000" style="border:groove"><div align="center">BUSCAR<br />
  ...
  <tr>
    <td height="163"></td>
    <td colspan="3" rowspan="3" valign="top" bgcolor="#FFFFFF"><!--DWLayoutEmptyCell-->&nbsp;</td>
  </tr>
